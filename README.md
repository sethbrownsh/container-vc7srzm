...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vc7srzm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vc7srzm.containers.anotherwebservice.com/
...
```
git clone git@github.com:sethbrownsh/container-vc7srzm.git
cd container-vc7srzm
```
...
```
docker attach container-vc7srzm
```
